...
image: /pic/chrome-ext-block.png
showcover: false
customcover: /pic/chrome-ext-force-custom-font.png
category: 教程
draft: false
...
![chrome-139.0.7258.128-about](/pic/chrome-139.0.7258.128-about.png)
:::
...
## 添加启动参数
![windows-chrome-lnk-panel](/pic/windows-chrome-lnk-panel.png)

1. 关闭 Chrome。
2. 打开 Chrome 的快捷方式属性。
3. 在 **目标** 后加上一个**空格**和 `--disable-features=ExtensionManifestV2Unsupported,ExtensionManifestV2Disabled`。
4. 点击 **确定**。
5. 再次双击 Chrome 快捷方式，打开 Chrome，即可启用旧版扩展（**暂时保留** 按钮将会出现）。 ![chrome-ext-force-custom-font-2](/pic/chrome-ext-force-custom-font-2.png)
